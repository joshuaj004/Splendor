...
document.getElementById("emeraldGem").onclick = function() {
    decrementHandler(emerald);
};
document.getElementById("sapphireGem").onclick = function() {
    decrementHandler(sapphire);
};
document.getElementById("rubyGem").onclick = function() {
    decrementHandler(ruby);
};
document.getElementById("diamondGem").onclick = function() {
    decrementHandler(diamond);
};
document.getElementById("onyxGem").onclick = function() {
    decrementHandler(onyx);
};
document.getElementById("goldGem").onclick = function() {
    decrementHandler(gold);
};
